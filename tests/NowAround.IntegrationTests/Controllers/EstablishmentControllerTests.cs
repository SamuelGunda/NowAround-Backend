...
public class EstablishmentControllerTests  : IClassFixture<StorageContextFixture>
{
    ...
    [Fact]
    public async Task UpdateEstablishmentGenericInfoAsync_WithValidRequest_ShouldReturnOk()
    {
        // Arrange
        var factory = new NowAroundWebApplicationFactory();
    ...
    [Fact]
    public async Task UpdateEstablishmentGenericInfoAsync_WithUnauthorizedUser_ShouldReturnUnauthorized()
    {
        // Arrange
        var factory = new NowAroundWebApplicationFactory();
    ...
    [Fact]
    public async Task UpdateEstablishmentGenericInfoAsync_WithInvalidSub_ShouldReturnForbidden()
    {
        // Arrange
        var factory = new NowAroundWebApplicationFactory();
    ...
    [Fact]
    public async Task UpdateEstablishmentGenericInfoAsync_WithInvalidAuth0Id_ShouldReturnNotFound()
    {
        // Arrange
        var factory = new NowAroundWebApplicationFactory();
